...
import { useCreateRewardMutation } from '@/hooks/use-rewards'
...
export const CreateRewardModal: React.FC<CreateRewardModalProps> = ({ open, onClose }) => {
      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto bg-app-surface-0 border border-app-border-accent text-app-text">
        ...
        <div className="space-y-5 py-2">
          <div className="space-y-2">
            ...
            <DarkInput
              placeholder="Например: Инноватор месяца"
              value={title}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Опишите критерии получения этой награды..."
              value={description}
        ...
        <DialogFooter className="border-t border-app-border-accent pt-4">
          ...
          >
            {createMutation.isPending ? 'Создание...' : 'Создать награду'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
